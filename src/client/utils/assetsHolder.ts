  ...
  return {
    player: {
      [PlayerPower.Default]: {
        ...
        [Direction.Bottom]: [
          mainSprite(64, 0, 16, 15),
          mainSprite(80, 0, 16, 15),
        ],
        [Direction.Right]: [
          mainSprite(96, 0, 16, 15),
          mainSprite(112, 0, 16, 15),
        ],
        [Direction.Left]: [
          mainSprite(32, 0, 16, 15),
          mainSprite(48, 0, 16, 15),
        ],
      },
      [PlayerPower.First]: {
        [Direction.Top]: [
          mainSprite(0, 32.3, 16, 15),
          mainSprite(15.7, 32.5, 16, 15),
        ],
        [Direction.Bottom]: [
          mainSprite(64, 32.3, 16, 15),
          mainSprite(80, 32.5, 16, 15),
        ],
        [Direction.Right]: [
          mainSprite(96, 32.3, 16, 15),
          mainSprite(112.3, 32, 16, 15),
        ],
        [Direction.Left]: [
          mainSprite(31.7, 32, 16, 15),
          mainSprite(48, 32, 16, 15),
        ],
      },
      [PlayerPower.Second]: {
        [Direction.Top]: [
          mainSprite(0, 48, 16, 15),
          mainSprite(15.7, 48, 16, 15),
        ],
        [Direction.Bottom]: [
          mainSprite(64, 48, 16, 15),
          mainSprite(80, 48, 16, 15),
        ],
        [Direction.Right]: [
          mainSprite(96, 48, 16, 15),
          mainSprite(112.3, 48, 16, 15),
        ],
        [Direction.Left]: [
          mainSprite(31.7, 48, 16, 15),
          mainSprite(48, 48, 16, 15),
        ],
      },
    },
    enemy: {
      [TankTypes.Default]: {
        [Direction.Top]: [
          mainSprite(128, 0, 16, 15),
          mainSprite(144, 0, 16, 15),
        ],
        [Direction.Bottom]: [
          mainSprite(192, 0, 16, 15),
          mainSprite(208, 0, 16, 15),
        ],
        [Direction.Right]: [
          mainSprite(223.7, 0, 16, 15),
          mainSprite(239.7, 0, 16, 15),
        ],
        [Direction.Left]: [
          mainSprite(160, 0, 16, 15),
          mainSprite(176, 0, 16, 15),
        ],
      },
      [TankTypes.Fast]: {
        [Direction.Top]: [
          mainSprite(128, 80, 16, 15),
          mainSprite(144, 80, 16, 15),
        ],
        [Direction.Bottom]: [
          mainSprite(192, 80, 16, 15),
          mainSprite(208, 80, 16, 15),
        ],
        [Direction.Right]: [
          mainSprite(224, 80, 16, 15),
          mainSprite(240, 80, 16, 15),
        ],
        [Direction.Left]: [
          mainSprite(160, 80, 16, 15),
          mainSprite(176, 80, 16, 15),
        ],
      },
      [TankTypes.Armored]: {
        "1": {
          [Direction.Top]: [
            mainSprite(128.5, 111.75, 14.75, 16),
            mainSprite(144.25, 111.75, 14.75, 16),
          ],
          [Direction.Bottom]: [
            mainSprite(191.75, 111.75, 15.25, 16),
            mainSprite(207.5, 111.75, 15.25, 16),
          ],
          [Direction.Right]: [
            mainSprite(222.75, 111.75, 16, 16),
            mainSprite(239, 111.75, 14.75, 16),
          ],
          [Direction.Left]: [
            mainSprite(159, 111.75, 16, 16),
            mainSprite(174.75, 111.75, 16, 16),
          ],
        },
        "2": {
          [Direction.Top]: [
            mainSprite(0, 240, 14.75, 16),
            mainSprite(16, 240, 14.75, 16),
          ],
          [Direction.Bottom]: [
            mainSprite(64, 240, 15.25, 16),
            mainSprite(80, 240, 15.25, 16),
          ],
          [Direction.Right]: [
            mainSprite(96, 240, 16, 16),
            mainSprite(112, 240, 14.75, 16),
          ],
          [Direction.Left]: [
            mainSprite(32, 240, 16, 16),
            mainSprite(48, 240, 16, 16),
          ],
        },
        "3": {
          [Direction.Top]: [
            mainSprite(128, 240, 14.75, 16),
            mainSprite(144, 240, 14.75, 16),
          ],
          [Direction.Bottom]: [
            mainSprite(192, 240, 15.25, 16),
            mainSprite(208, 240, 15.25, 16),
          ],
          [Direction.Right]: [
            mainSprite(224, 240, 16, 16),
            mainSprite(240, 240, 14.75, 16),
          ],
          [Direction.Left]: [
            mainSprite(160, 240, 16, 16),
            mainSprite(176, 240, 16, 16),
          ],
        },
      },
    },
    ...
    invincible: [
      mainSprite(256, 144, 15.7, 16),
      mainSprite(272.2, 144, 15.7, 16),
    ],
  };
};
...
const setupVariableSprites = (image: HTMLImageElement): VariableSprites => {
  ...
  return {
    ...
    tankDestruction: [
      ...
      {
        sprite: mainSprite(304.5, 128.75, 30.5, 31.25),
        size: { x: 60, y: 60 },
      },
      { sprite: mainSprite(288.25, 128.75, 16, 15.5), size: { x: 40, y: 40 } },
      {
        sprite: mainSprite(272.25, 128.75, 15.75, 14.25),
        size: { x: 37, y: 37 },
      },
